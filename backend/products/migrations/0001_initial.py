    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('food_type', models.CharField(choices=[('veg', 'Veg'), ('non_veg', 'Non-Veg'), ('both', 'Both')], default='veg', max_length=20)),
        ...
        migrations.AddIndex(
            model_name='product',
            index=models.Index(fields=['is_hot_item', 'is_popular'], name='products_pr_is_hot__1d1e4e_idx'),
        ),
    ]
